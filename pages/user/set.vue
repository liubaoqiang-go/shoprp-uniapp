...
<template>
  <view class="set-wrap">
    ...
    <view class="set-box">
      <view
        class="cell-item u-flex u-col-center u-row-between u-p-x-30 u-p-y-20"
      >
    ...
    <!-- copyright -->
    <view
      class="copyright-box u-flex-col u-row-center u-col-center u-p-t-80 u-p-b-50"
      v-if="initShop.copyright"
    >
